      ...
      <DropdownMenu onOpenChange={setIsOpen}>
        <div className='group relative'>
          <DropdownMenuTrigger asChild>
            <button
              type='button'
              className='flex items-center gap-3 p-3 rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-200/60 dark:border-zinc-800/60 hover:border-zinc-300 dark:hover:border-zinc-700 hover:bg-zinc-50/80 dark:hover:bg-zinc-800/40 hover:shadow-sm transition-all duration-200 focus:outline-none w-full'
            >
